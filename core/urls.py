...
urlpatterns = [
    ...
    path("uploads/<int:upload_id>/update/", core_views.update_upload, name="update_upload"),
    path("uploads/<int:upload_id>/delete/", core_views.delete_upload, name="delete_upload"),
